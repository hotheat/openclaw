...
export { MemorySearchSchema } from "./zod-schema.memory-search.js";
...
export const ToolsWebGrokSearchSchema = z
  .object({
    enabled: z.boolean().optional(),
    apiKey: z.string().optional().register(sensitive),
    model: z.string().optional(),
...
export const ToolsWebSchema = z
  .object({
    ...
    grokSearch: ToolsWebGrokSearchSchema,
...
export const AgentEntrySchema = z
  .object({
    ...
    imageModel: z.union([AgentModelSchema, z.null()]).optional(),
...
export const ToolsSchema = z
  .object({
    ...
    exec: ToolExecSchema,
    fs: ToolFsSchema,
    // Deprecated compatibility-only field. The artifact_jobs tool has been removed.
    artifactJobs: z
      .object({

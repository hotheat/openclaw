...
export type AgentDefaultsConfig = {
  ...
  repoRoot?: string;
  /** Optional runtime security policy file path injected into every system prompt. */
  ...
  /** Default reasoning visibility when no /reasoning directive or session override is present. */
  ...
  subagents?: {
    ...
    /** Agent ids allowed as cross-agent sessions_spawn targets by default. */
    allowAgents?: string[];
